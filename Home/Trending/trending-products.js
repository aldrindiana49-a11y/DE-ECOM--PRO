  ...
  function renderTrendingProducts(productList = []) {
    ...
    (function () {
      ...
      function getTrendingProducts(productList = []) {
        ...
        return hasTrendingData
          ? scored.sort((a, b) => b.trendingScore - a.trendingScore).slice(0, 10)
          : scored.slice(0, 10);
      }
      ...
      <div class="trending-outer">
        ...
        <button class="trending-outside-btn trending-outside-prev"
                type="button"
                onclick="scrollTrendingProducts(-1)">
          &lt;
        </button>
        ...
        <button class="trending-outside-btn trending-outside-next"
                type="button"
                onclick="scrollTrendingProducts(1)">
          &gt;
        </button>
